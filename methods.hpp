...
void SynthesizeXRays(string ct_filename, string nodule_specs_filename, double voxel_xy_dim, double voxel_z_dim); // changed 

/// top level wrapper function
void SynthesizeXRaysFromCT(NoduleSpecs nodule_spec,vector<vector<vector<Voxel *>>> ctVoxels, Coordinate *); // changed 
